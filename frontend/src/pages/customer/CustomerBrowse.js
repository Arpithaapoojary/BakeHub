      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        >
          <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
            <div>
              <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900">
                Find <span className="text-pink-600">Nearby Bakeries</span>
              </h1>
          ...
          <div className="mt-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
            {/* City filter */}
            <div className="flex items-center bg-white rounded-xl border border-pink-200 px-4 py-2 shadow-sm w-full md:w-64">
            ...
            {/* Search */}
            <div className="flex items-center bg-white rounded-xl border border-pink-200 px-4 py-2 shadow-sm w-full md:w-72">
            ...
            {/* Sort */}
            <div className="bg-white rounded-xl border border-pink-200 px-4 py-2 shadow-sm w-full md:w-52">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {processedBakeries.map((b, index) => (
            <motion.div
              ...
              className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition border border-pink-100 overflow-hidden cursor-pointer"
...
/>
                ...
                {/* DISTANCE BADGE */}
                {b.distanceKm != null && (
                  <div className="absolute top-3 right-3 bg-white/90 text-pink-700 text-xs px-3 py-1 rounded-full">
                    {b.distanceKm < 1
