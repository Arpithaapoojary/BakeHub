  ...
  if (loading)
    return (
      <div className="h-screen flex justify-center items-center">
        <Loader2 className="text-pink-600 w-10 h-10 animate-spin" />
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-pink-50 to-white">
      ...
      <div className="max-w-3xl mx-auto -mt-10 px-4 relative z-20">
        <div className="bg-white flex items-center gap-3 p-4 rounded-3xl shadow-lg border border-pink-100">
          <Search className="text-pink-600 w-5 h-5" />
